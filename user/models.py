...
class UserData(models.Model):
    ...
    position_show = models.BooleanField(default=True)
    status = models.TextField(null=True, blank=True)
    status_show = models.BooleanField(default=True)
    additional_info = models.TextField(null=True, blank=True)
    additional_info_show = models.BooleanField(default=True)
    fullname = models.TextField(null=True, blank=True)
    fullname_show = models.BooleanField(default=True)
    surname = models.TextField(null=True, blank=True)
    surname_show = models.BooleanField(default=True)
    lastname = models.TextField(null=True, blank=True)
    lastname_show = models.BooleanField(default=True)
    phone_number = models.TextField(null=True, blank=True)
    phone_number_show = models.BooleanField(default=True)
    contact_telegram = models.TextField(null=True, blank=True)
    contact_telegram_show = models.BooleanField(default=True)
    contact_email = models.TextField(null=True, blank=True)
    contact_email_show = models.BooleanField(default=True)
    city = models.TextField(default="Москва")
    city_show = models.BooleanField(default=True)
    date_of_birth = models.DateField(null=True, blank=True)
    date_of_birth_show = models.BooleanField(default=True)
    sex = models.TextField(null=True, blank=True)
    sex_show = models.BooleanField(default=True)
    graduation_place = models.TextField(null=True, blank=True)
    graduation_place_show = models.BooleanField(default=True)
    education_level = models.CharField(null=True, blank=True)
    education_level_show = models.BooleanField(default=True)
    graduation_date = models.DateField(null=True, blank=True)
    graduation_date_show = models.BooleanField(default=True)
    languages = ArrayField(models.CharField(blank=True, null=True), null=True, blank=True)
    languages_show = models.BooleanField(default=True)
    curses = ArrayField(models.CharField(blank=True, null=True), null=True, blank=True)
    curses_show = models.BooleanField(default=True)
    ...
    font_color = models.CharField(null=True, blank=True)
    font_size = models.CharField(null=True, blank=True)
    def __str__(self):
